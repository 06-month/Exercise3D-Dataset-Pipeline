...
3. `pgrep -af 'sapiens2_target_pipeline.py|run_autonomous_generation.py|run_sam_body4d_full.py|benchmark_sam_body4d.py'`와 `nvidia-smi`로 실행 중 process/GPU를 확인한다.
